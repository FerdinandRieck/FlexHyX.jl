...
function plotsol(sol,t)
  n_par = 1
  p1 = plot(t/3600,sol[50,:], linewidth = 2, xlabel = "Zeit /h", ylabel = "W", title = "Leistung", label = "iV-P",legend=:topright, legend_columns=-1)
  p1 = plot!(t/3600,sol[51,:], linewidth = 2, label = "iPV-P")
  p2 = plot(t/3600,sol[26,:], linewidth = 2, xlabel = "Zeit /h", ylabel = "A", title = "Ströme", label = "iB",legend=:bottom, legend_columns=-1)
  p2 = plot!(t/3600,sol[34,:], linewidth = 2, label = "iE")
  p2 = plot!(t/3600,sol[39,:], linewidth = 2, label = "iBZ")
  p3 = plot(t/3600,sol[2,:], linewidth = 2, xlabel = "Zeit /h", ylabel = "V", title = "Spannungen", label = "U3", legend=:bottom)
