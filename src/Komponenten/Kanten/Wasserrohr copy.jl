...
#--- in-place + kante.Param.
 BenchmarkTools.Trial: 4 samples with 1 evaluation.
 Range (min … max):  1.314 s …   1.427 s  ┊ GC (min … max): 4.27% … 3.45%
 Time  (median):     1.374 s              ┊ GC (median):    3.79%
 Time  (mean ± σ):   1.372 s ± 46.524 ms  ┊ GC (mean ± σ):  3.78% ± 0.41%

  █                          █     █                      █  
  █▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁█▁▁▁▁▁█▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁█ ▁
  1.31 s         Histogram: frequency by time        1.43 s <

 Memory estimate: 296.10 MiB, allocs estimate: 6623480.
